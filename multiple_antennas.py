...
Original file is located at
    https://colab.research.google.com/drive/1UDQPCne8qgEAhEqIJimX2WYsGgaCKkFF
"""
...
for i in range(ANTENNA_N):
  ...
  SIZE_W=int(input("engez yallaaaa (width)!!!??"))
  print(SIZE_W,SIZE_H)
  TrainingFunction(epsilon=0.5,EPS_DECAY=0.9999,HM_EPISODES=2500,SIZE_H=SIZE_H,SIZE_W=SIZE_W,type_="omnidirectionnel")
  print(outputOfTraining(q_table))
